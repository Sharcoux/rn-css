...
styled.DatePickerIOS = styled(RN.DatePickerIOS)
...
styled.Picker = styled(RN.Picker)
styled.PickerIOS = styled(RN.PickerIOS)
styled.ProgressBarAndroid = styled(RN.ProgressBarAndroid)
styled.ProgressViewIOS = styled(RN.ProgressViewIOS)
styled.ScrollView = styled(RN.ScrollView)
styled.SegmentedControlIOS = styled(RN.SegmentedControlIOS)
styled.Slider = styled(RN.Slider)

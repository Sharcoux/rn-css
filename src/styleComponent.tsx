...
styledFlatList.attrs = <S, >(opts: Partial<S & FlatListProps<any>> | ((props: S & FlatListProps<any>) => Partial<S & FlatListProps<any>>)) => (chunks: TemplateStringsArray, ...functs: (Primitive | Functs<S & FlatListProps<any>>)[]) => <Props, >(props: S & FlatListProps<Props> & OptionalProps) => styled<FlatListProps<Props>>(FlatList).attrs<S>(opts)(chunks, ...functs)(props)
